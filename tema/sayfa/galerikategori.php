...
$kategoriControl = $db->prepare("SELECT * FROM galerikategori WHERE kategori_id=:id AND kategori_url=:url AND kategori_durum=:durum");
                            ...
                            <ul itemscope itemtype="https://schema.org/BreadcrumbList">
                                ...
                                <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                                  ...
                                  <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                                    ...
                                    <a itemprop="item" href="<?php echo URL.GBURL."/".$kategoriRow["kategori_id"]."_".$kategoriRow["kategori_url"];?>/">
                                        <span itemprop="name">
                    ...
                    <div class="col-md-12 col-12">
                        <div class="catOutline">
                            ...
                            <div class="prodCartKapsar">
                                ...
                                $limit = 30;
                                $query = "SELECT * FROM makalegaleri WHERE sayfa_durum=1 AND sayfa_tarih <= NOW() AND secenekHaber=1 AND portkat='$urunGet' ORDER BY sayfa_tarih DESC";
                                $s = $db->prepare($query);
                                $s->execute();
                                ...
                                $show = "SELECT * FROM makalegaleri WHERE sayfa_durum=1 AND sayfa_tarih <= NOW() AND secenekHaber=1 AND portkat='$urunGet'   ORDER BY sayfa_tarih DESC LIMIT $starting_limit, $limit";
                                $r = $db->prepare($show);
                                $r->execute();
                                while($res = $r->fetch(PDO::FETCH_ASSOC)):
                                $haberUrl = LURL.GALERİ.$res["sayfa_url"].'/'
                                ?>
                                 <div class="productCartv2" itemscope itemtype="http://schema.org/NewsArticle">
                                    ...
                                    <div class="cartImgv2" itemprop="image" itemscope itemtype="https://schema.org/ImageObject"><a href="<?php echo $haberUrl;?>"> <img class="img-fluid" src="<?php echo URL.'images/makalegaleri/640x360/'.$res["sayfa_resim"];?>" alt="<?php if($res["resim_baslik"]){ echo $res["resim_baslik"] ;}else{ echo $res[$lehce."sayfa_adi"];} ?>"> </a>
                                    <meta itemprop="url" content="<?php echo URL.'images/makalegaleri/640x360/'.$res["sayfa_resim"];?>" />
