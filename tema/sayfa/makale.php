...
if(isset($_GET["url"])){
$urlSef = g("url");
$sayfaControl = $db->prepare("SELECT * FROM makaleler INNER JOIN haberkategori ON kategori_id=portkat INNER JOIN uyeler ON uye_id=sayfa_yazar WHERE sayfa_url=:url AND sayfa_durum=:durum AND sayfa_tarih <= NOW()");
...
$hit = $db->prepare("UPDATE makaleler SET yazi_total_hit= yazi_total_hit +1 WHERE sayfa_id=?");
$hit->execute(array($id));
$hit2 = $db->prepare("UPDATE makaleler SET yazi_gunluk_hit= yazi_gunluk_hit +1 WHERE sayfa_id=?");
...
<html lang="tr-TR">
    <head>
        ...
        "image": [
        "<?php echo URL.'images/makaleler/640x360/'.$sayfaRow['sayfa_resim'];?>"
        ],
        ...
        <section id="kategoriSlider">
            <div class="container">
                <div class="masaustureklam mb-2 mt-2">
                    <?php echo html_entity_decode($blokRownews["baslik4"]); ?>
                </div>
                <div class="mobilreklam mb-2 mt-2">
                    <?php echo html_entity_decode($blokRownews["baslik7"]); ?>
                </div>
                        ...
                        <div class="breadcrump">
                            <ul itemscope itemtype="https://schema.org/BreadcrumbList">
                                ...
                                <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                                        ...
                                        <a itemprop="item" href="<?php echo LURL.HBURL."/".$sayfaRow["kategori_id"]."_".$sayfaRow["kategori_url"]; ?>">
                                             <span itemprop="name">
                                ...
                                <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                                    <a itemprop="item" href="<?php echo LURL.HABER.$sayfaRow["sayfa_url"].'/'; ?>">
                                        <span itemprop="name">
                                ...
                                <div class="detailDescrtiption">
                                    ...
                                    <div class="fotoAuthor">
                                        ...
                                        <div class="dateAndCatName">
                                            ...
                                            <div class="catName">
                                                <?php echo $blokRowdil["desc8"]; ?><a href="<?php echo LURL.HBURL."/".$sayfaRow["kategori_id"]."_".$sayfaRow["kategori_url"]; ?>"> <?php echo $sayfaRow["kategori_adi"]; ?></a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="detailImg mb10">
                                        ...
                                        <img class="img-fluid" src="<?php echo URL.'images/makaleler/640x360/'.$sayfaRow["sayfa_resim"];?>" alt="<?php if($sayfaRow["resim_baslik"]){ echo $sayfaRow["resim_baslik"] ;}else{ echo $sayfaRow[$lehce."sayfa_adi"];} ?>">
                                        <?php  } ?>
                                    </div>
                                    ...
                                    <div class="masaustureklam mb-2">
                                        <?php echo html_entity_decode($blokRownews["desc4"]); ?>
                                    </div>
                                    <div class="mobilreklam mb-2 mt-2">
                                        <?php echo html_entity_decode($blokRownews["desc7"]); ?>
                                    </div>
                                    <p>
...
<?php } ?>
                            ...
                            <div class="masaustureklam mb-2">
                                <?php echo html_entity_decode($blokRownews["baslik5"]); ?>
                            </div>
                            <div class="mobilreklam mb-2 mt-2">
                                <?php echo html_entity_decode($blokRownews["baslik8"]); ?>
                            </div>
                            <div class="benzerIcerikler">
                                ...
                                <div class="catesList">
                                    <ul>
                                        <?php
                                        $haberQuery = $db->query("SELECT * FROM makaleler WHERE sayfa_durum=1 AND sayfa_tarih <= NOW() AND secenekHaber=1 AND portkat='$kat_id' ORDER BY RAND() DESC LIMIT 4 ");
                        ...
                        <div class="masaustureklam mb-2">
                            <?php echo html_entity_decode($blokRownews["desc5"]); ?>
                        </div>
                        <div class="mobilreklam mb-2 mt-2">
                            <?php echo html_entity_decode($blokRownews["desc8"]); ?>
                        </div>
                        ...
                        <div class="catOutline">
                            ...
                            <div class="prodCartKapsar">
                                <div class="catesList">
                                    <ul>
                                        <?php
                                        $haberQuery = $db->query("SELECT * FROM makaleler WHERE sayfa_durum=1 AND sayfa_tarih <= NOW() AND secenekHaber=1 AND makalekonum_sonyazilar='on' ORDER BY sayfa_tarih DESC LIMIT 8 ");
                                        if( $haberQuery->rowCount() ){
                                        foreach($haberQuery as $haberRow){
                                        $haberUrl = LURL.HABER.$haberRow["sayfa_url"].'/';
                                        ?>
                    ...
                    <div class="masaustureklam mt-3">
                        <?php echo html_entity_decode($blokRownews["baslik6"]); ?>
                    </div>
                    <div class="catOutline mt20">
                        ...
                        <div class="prodCartKapsar">
                            <div class="productCart noneShadow mb0">
                                <?php
                                $haberQuery12 = $db->query("SELECT * FROM makaleler WHERE sayfa_durum=1 AND sayfa_tarih <= NOW() AND secenekHaber=1 AND makale_durum_pop='on' ORDER BY sayfa_tarih DESC LIMIT 0,1 ");
                            ...
                            <div class="catesList">
                                <ul>
                                    <?php
                                    $haberQuery12 = $db->query("SELECT * FROM makaleler WHERE sayfa_durum=1 AND sayfa_tarih <= NOW() AND secenekHaber=1 AND makale_durum_pop='on' ORDER BY sayfa_tarih DESC LIMIT 1,5 ");
                                    if( $haberQuery12->rowCount() ){
                                    foreach($haberQuery12 as $haberRow12){
                                    $haberUrl = LURL.HABER.$haberRow12["sayfa_url"].'/';
                                    ?>
                ...
                <div class="catOutline mt20">
                    ...
                    <div class="prodCartKapsar">
                        <div class="productCart noneShadow mb0">
                            ...
                            $haberQuery12xx = $db->query("SELECT * FROM makaleler WHERE sayfa_durum=1 AND sayfa_tarih <= NOW() AND secenekHaber=1 AND portkat='$katid' ORDER BY sayfa_tarih DESC LIMIT 0,1 ");
                        ...
                        <div class="catesList">
                            <ul>
                                <?php
                                $haberQuery12xx = $db->query("SELECT * FROM makaleler WHERE sayfa_durum=1 AND sayfa_tarih <= NOW() AND secenekHaber=1 AND portkat='$katid' ORDER BY sayfa_tarih DESC LIMIT 1,5 ");
                                if( $haberQuery12xx->rowCount() ){
                                foreach($haberQuery12xx as $haberRow12xx){
                                $haberUrl = LURL.HABER.$haberRow12xx["sayfa_url"].'/';
                                ?>
            ...
            <div style="clear: both;"></div>
            <div class="masaustureklam mt-3">
                <?php echo html_entity_decode($blokRownews["desc6"]); ?>
            </div>
