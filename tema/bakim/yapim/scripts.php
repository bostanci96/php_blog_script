...
$tarih = $bakim["bakim_tarih"];

$dizi = explode ("-",$tarih);

	

$saat = $bakim["bakim_saat"];
...
$(document).ready(function(){
	...
	if ( $.fn.countdown ) {
		var now = new Date();
		var date = new Date('<?php echo $dizi[0];?>','<?php echo $dizi[1];?>','<?php echo $dizi[2];?>','<?php echo $rakam[0];?>','<?php echo $rakam[1];?>','<?php echo $rakam[2];?>');
