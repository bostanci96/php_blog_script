<?php
$haberQuery = $db->query("SELECT * FROM haberkategori WHERE kategori_durum=1 AND kat_anasayfa=1 ORDER BY sira_no ASC ");
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-12">
                <div class="cartList">
                    <?php
                    $haber12 = $db->query("SELECT * FROM makaleler WHERE sayfa_durum=1 AND sayfa_tarih <= NOW() AND secenekHaber=1 and portkat='$haberkatid' ".$siralama." LIMIT ".$limitverlan." ");
                    if( $haber12->rowCount() ){
                    foreach($haber12 as $haberRowx12){
                    $haberUrl = LURL.HABER.$haberRowx12["sayfa_url"].'/';
                    ?>
                    
                    <div class="productCart" itemscope itemtype="http://schema.org/NewsArticle">
                        <meta itemprop="datePublished" content="<?php echo tarih($haberRowx12["sayfa_tarih"]);?>" />
                        <meta itemprop="dateModified" content="<?php echo tarih($haberRowx12["sayfa_tarih"]);?>" />
                        <meta itemscope itemprop="mainEntityOfPage" itemtype="https://schema.org/WebPage" itemid="<?php echo $haberUrl; ?>" />
                        <div class="cartImg" itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
                            <a target="_blank" href="<?php echo $haberUrl; ?>">
                                <span><?php echo $haberRow["kategori_adi"] ?></span>
                                <img width="300" height="170" class="img-fluid lazyload" src="<?=URL.'images/lazy.png'?>" data-src="<?php echo URL.'images/makaleler/640x360/'.$haberRowx12["sayfa_resim"];?>" alt="<?php if($haberRowx12["resim_baslik"]){ echo $haberRowx12["resim_baslik"] ;}else{ echo $haberRowx12["sayfa_adi"];} ?>">
                            </a>
                            <meta itemprop="url" content="<?php echo URL.'images/makaleler/640x360/'.$haberRowx12["sayfa_resim"];?>" />
                            <meta itemprop="width" content="640" />
                            <meta itemprop="height" content="360" />
                        </div>
                        <div class="cartDesc pb18">
                            <a target="_blank" href="<?php echo $haberUrl; ?>"><h3 itemprop="headline"> <?php echo $haberRowx12["sayfa_adi"];?> </h3></a>
            ...
            <div class="col-md-12 col-12">
                <div class="catOutline">
                    ...
                    <div class="prodCartKapsar">
                        <?php
                        $haberaltxy11 = $db->query("SELECT * FROM makaleler WHERE sayfa_durum=1 AND sayfa_tarih <= NOW() AND secenekHaber=1 and portkat='$haberkatid'  ".$siralama." LIMIT ".$limitverlan." ");
                        ...
                        <div class="productCartv2">
                            <div class="cartImgv2"><a target="_blank" href="<?php echo $haberUrl; ?>"> <img width="310" height="175" class="img-fluid lazyload" src="<?=URL.'images/lazy.png'?>" data-src="<?php echo URL.'images/makaleler/640x360/'.$haberRowxy11["sayfa_resim"];?>" alt="<?php if($haberRowxy11["resim_baslik"]){ echo $haberRowxy11["resim_baslik"] ;}else{ echo $haberRowxy11["sayfa_adi"];} ?>"> </a></div>
...
<section id="poem">
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-12">
                <div class="catOutline">
                    <div class="themeCatTitle">
                        <img class="img-fluid" width="85" height="50" src="<?php echo URL.'images/kategoriler/big/'.$haberRow["kategori_resim"];?>" width="25" height="25" alt="<?php if($haberRow["resim_baslik"]){ echo $haberRow["resim_baslik"] ;}else{ echo $haberRow["kategori_adi"];} ?>"> <?php echo $haberRow["kategori_adi"] ?>
                    </div>
                    <div class="poemContainer">
                        <?php
                        $haberaltxy44 = $db->query("SELECT * FROM makaleler INNER JOIN uyeler ON uye_id=sayfa_yazar WHERE sayfa_durum=1 AND sayfa_tarih <= NOW() AND secenekHaber=1 and portkat='$haberkatid' ".$siralama." LIMIT ".$limitverlan." ");
                        if( $haberaltxy44->rowCount() ){
                        foreach($haberaltxy44 as $haberRowxy44){
                        $haberUrl = LURL.HABER.$haberRowxy44["sayfa_url"].'/';
  ...
  $yazaradi = $haberRowxy44["uye_kadi"];
      ...
      $yazaradi = $haberRowxy44["uye_ad"]." ".$haberRowxy44["uye_soyad"];
                        ...
                        <div class="poemCard">
                            <div class="poemImg">
                                <a target="_blank" href="<?php echo $haberUrl; ?>"><img width="85" height="50" class="img-fluid lazyload" src="<?=URL.'images/lazy.png'?>" data-src="<?php echo URL.'images/makaleler/640x360/'.$haberRowxy44["sayfa_resim"];?>" alt="<?php if($haberRowxy44["resim_baslik"]){ echo $haberRowxy44["resim_baslik"] ;}else{ echo $haberRowxy44["sayfa_adi"];} ?>"></a>
                            </div>
                            <div class="poemDesc">
                                <a target="_blank" href="<?php echo $haberUrl; ?>"><p><?php echo $haberRowxy44["sayfa_adi"];?> </p></a>
                ...
                <div class="catOutline">
                    ...
                    <div class="catSliders3">
                        <ul class="owl-carousel owl-theme">
                            <?php
                            $haberaltxy77 = $db->query("SELECT * FROM makaleler WHERE sayfa_durum=1 AND sayfa_tarih <= NOW() AND secenekHaber=1 and portkat='$haberkatid'  ".$siralama." LIMIT ".$limitverlan." ");
                            if( $haberaltxy77->rowCount() ){
                            foreach($haberaltxy77 as $haberRowxy77){
                            $haberUrl = LURL.HABER.$haberRowxy77["sayfa_url"].'/';
                            ?>
                            <li> <a target="_blank" href="<?php echo $haberUrl; ?>"> <img width="315" height="180" class="img-fluid owl-lazy" data-src="<?php echo URL.'images/makaleler/640x360/'.$haberRowxy77["sayfa_resim"];?>" alt="<?php if($haberRowxy77["resim_baslik"]){ echo $haberRowxy77["resim_baslik"] ;}else{ echo $haberRowxy77["sayfa_adi"];} ?>"> <h2> <?php echo $haberRowxy77["sayfa_adi"];?> </h2> </a> </li>
        ...
        <div class="row">
            <div class="col-md-12 col-12">
                <div class="catOutline">
                    ...
                    <div class="prodCartKapsar">
                        <?php
                        $haberaltxy99 = $db->query("SELECT * FROM makaleler WHERE sayfa_durum=1 AND sayfa_tarih <= NOW() AND secenekHaber=1 and portkat='$haberkatid' ".$siralama." LIMIT ".$limitverlan." ");
                        if( $haberaltxy99->rowCount() ){
                        foreach($haberaltxy99 as $haberRowxy99){
                        $haberUrl = LURL.HABER.$haberRowxy99["sayfa_url"].'/';
                        ?>
                        <div class="productCartv2">
                            <div class="cartImgv2"><a target="_blank" href="<?php echo $haberUrl; ?>"> <img width="310" height="175" class="img-fluid lazyload" src="<?=URL.'images/lazy.png'?>" data-src="<?php echo URL.'images/makaleler/640x360/'.$haberRowxy99["sayfa_resim"];?>" alt="<?php if($haberRowxy99["resim_baslik"]){ echo $haberRowxy99["resim_baslik"] ;}else{ echo $haberRowxy99["sayfa_adi"];} ?>"> </a></div>
                            <div class="cartDescv2">
            ...
            <div class="col-md-12 col-12">
                <div class="catOutline">
                    ...
                    <div class="prodCartKapsar maxw">
                        <?php
                        $haber188 = $db->query("SELECT * FROM makaleler WHERE sayfa_durum=1 AND sayfa_tarih <= NOW() AND secenekHaber=1 and portkat='$haberkatid' ".$siralama." LIMIT 0,2");
                        if( $haber188->rowCount() ){
                        foreach($haber188 as $haberRowxy188){
                        $haberUrl = LURL.HABER.$haberRowxy188["sayfa_url"].'/';
                        ?>
                        <div class="productCartv2">
                            <div class="cartImgv2">
                                <a target="_blank" href="<?php echo $haberUrl; ?>"> <img width="315" height="180" class="img-fluid lazyload" src="<?=URL.'images/lazy.png'?>" data-src="<?php echo URL.'images/makaleler/640x360/'.$haberRowxy188["sayfa_resim"];?>" alt="<?php if($haberRowxy188["resim_baslik"]){ echo $haberRowxy188["resim_baslik"] ;}else{ echo $haberRowxy188["sayfa_adi"];} ?>" /> </a>
                            </div>
                            <div class="cartDescv2">
                                <div class="cartDatev2"><img width="13" height="13" src="<?php echo TEMA_URL;?>ast/img/clock.png" alt="" />  <?php echo tarih($haberRowxy188["sayfa_tarih"]);?></div>
                                <div class="cartScorev2">
                                    <div class="rating-stars text-center">
                                        <ul id="stars">
                    ...
                    <div class="prodCartKapsarList catesList">
                        <ul>
                            <?php
                            $haber188 = $db->query("SELECT * FROM makaleler WHERE sayfa_durum=1 AND sayfa_tarih <= NOW() AND secenekHaber=1 and portkat='$haberkatid' ".$siralama." LIMIT 2,3");
                            if( $haber188->rowCount() ){
                            foreach($haber188 as $haberRowxy188){
                            $haberUrl = LURL.HABER.$haberRowxy188["sayfa_url"].'/';
                            ?>
                            <li>
                                <a target="_blank" href="<?php echo $haberUrl; ?>">
                                    <div class="catesImg"><img width="105" height="60" class="img-fluid lazyload" src="<?=URL.'images/lazy.png'?>" data-src="<?php echo URL.'images/makaleler/640x360/'.$haberRowxy188["sayfa_resim"];?>" alt="<?php if($haberRowxy188["resim_baslik"]){ echo $haberRowxy188["resim_baslik"] ;}else{ echo $haberRowxy188["sayfa_adi"];} ?>" /></div>
                                    <div class="catesDesc">
            ...
            <div class="col-md-12">
                <div class="catOutline">
                    ...
                    <div class="popularLyrics">
                        <ul>
                            <?php
                            $haberaltxy45 = $db->query("SELECT * FROM makaleler WHERE sayfa_durum=1 AND sayfa_tarih <= NOW() AND secenekHaber=1 and portkat='$haberkatid' ".$siralama." LIMIT ".$limitverlan." ");
                            if( $haberaltxy45->rowCount() ){
                            $sayac=0;
                            foreach($haberaltxy45 as $haberRowxy45){
                            $haberUrl = LURL.HABER.$haberRowxy45["sayfa_url"].'/';
                            $sayac++;
                            ?>
        ...
        <div class="row">
            <div class="col-md-12 col-12">
                <div class="catOutline">
                    ...
                    <?php
                    $haberaltxy999 = $db->query("SELECT * FROM makaleler WHERE sayfa_durum=1 AND sayfa_tarih <= NOW() AND secenekHaber=1 and portkat='$haberkatid' ".$siralama." LIMIT ".$limitverlan." ");
                    if( $haberaltxy999->rowCount() ){
                    foreach($haberaltxy999 as $haberRowxy77){
                    $haberUrl = LURL.HABER.$haberRowxy77["sayfa_url"].'/';
                    ?>
                    <div class="productCart noneShadow">
                        <div class="cartImg"><a target="_blank" href="<?php echo $haberUrl; ?>"> <span><?php echo $haberRow["kategori_adi"] ?></span> <img class="img-fluid" src="<?php echo URL.'images/makaleler/640x360/'.$haberRowxy77["sayfa_resim"];?>" width="310" height="175" alt="<?php if($haberRowxy77["resim_baslik"]){ echo $haberRowxy77["resim_baslik"] ;}else{ echo $haberRowxy77["sayfa_adi"];} ?>"> </a></div>
                        <div class="cartDesc">
            ...
            <div class="">
                <div class="multiCates">
                    <div class="catOutline catesList">
                        <div class="themeCatTitle"><img class="img-fluid" src="<?php echo URL.'images/kategoriler/big/'.$haberRow["kategori_resim"];?>" width="25" height="25" alt="<?php if($haberRow["resim_baslik"]){ echo $haberRow["resim_baslik"] ;}else{ echo $haberRow["kategori_adi"];} ?>" /> <?php echo $haberRow["kategori_adi"] ?></div>
                        <?php
                        $haber188xx = $db->query("SELECT * FROM makaleler WHERE sayfa_durum=1 AND sayfa_tarih <= NOW() AND secenekHaber=1 and portkat='$haberkatid' ".$siralama." LIMIT 0,1");
                        if( $haber188xx->rowCount() ){
                        foreach($haber188xx as $haberRowxy188xx){
                        $haberUrl = LURL.HABER.$haberRowxy188xx["sayfa_url"].'/';
                        ?>
                        <div class="catesManset">
                            <a target="_blank" href="<?php echo $haberUrl; ?>">
                                <img class="img-fluid" width="310" height="175" src="<?php echo URL.'images/makaleler/640x360/'.$haberRowxy188xx["sayfa_resim"];?>" alt="<?php if($haberRowxy188xx["resim_baslik"]){ echo $haberRowxy188xx["resim_baslik"] ;}else{ echo $haberRowxy188xx["sayfa_adi"];} ?>" />
                        ...
                        <ul>
                            <?php
                            $haber188xx = $db->query("SELECT * FROM makaleler WHERE sayfa_durum=1 AND sayfa_tarih <= NOW() AND secenekHaber=1 and portkat='$haberkatid' ".$siralama." LIMIT 1,3");
                            if( $haber188xx->rowCount() ){
                            foreach($haber188xx as $haberRowxy188xx){
                            $haberUrl = LURL.HABER.$haberRowxy188xx["sayfa_url"].'/';
                            ?>
                            <li>
                                <a target="_blank" href="<?php echo $haberUrl; ?>">
                                    <div class="catesImg"><img width="105" height="60" class="img-fluid" src="<?php echo URL.'images/makaleler/640x360/'.$haberRowxy188xx["sayfa_resim"];?>" alt="<?php if($haberRowxy188xx["resim_baslik"]){ echo $haberRowxy188xx["resim_baslik"] ;}else{ echo $haberRowxy188xx["sayfa_adi"];} ?>" /></div>
                                    <div class="catesDesc">
