...
$kquery = $db->query("SELECT * FROM makaleler INNER JOIN haberkategori ON kategori_id=portkat INNER JOIN uyeler ON uye_id=sayfa_yazar ORDER BY sayfa_tarih DESC");
...
exportExcel($ayar["site_title"]."-Yazılar",$columns,$data,$replaceDotCol);
