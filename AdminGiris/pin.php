...
if(isset($_SESSION["pinkont"])){go(ADMIN_URL."login.php");die();}
...
<head>
	...
	<meta name="keywords" content="<?php echo $ayar["site_title"];?> Yönetim Paneli , <?php echo $ayar["site_title"];?> Web Tasarım Yönetim Paneli , Administrator | <?php echo $ayar["site_title"];?> Yönetim Paneli, Bostanci96">
	<meta name="author" content="Bostanci96">
			...
			<div class="content-body">
				<section class="row flexbox-container">
					<div class="col-xl-8 col-11 d-flex justify-content-center">
						<div class="card bg-authentication rounded-0 mb-0" style="background: #343a40!important;">
							<div class="row m-0">
							
								<div class="col-lg-12 col-12 p-0" style="    background-color: #FFFFFF; padding-top: 2rem!important;">
									<div class="card rounded-0 mb-0 px-2">
										...
										<p class="px-2">Lütfen hesabınıza ait pin bilgisini girin.</p>
										<div class="card-content">
											<div class="card-body pt-1">
												<form role="form"  action="ajax.php?p=pin" id="LoginForm" method="post" onsubmit="return false;">
													<fieldset class="form-label-group form-group position-relative has-icon-left">
														<input type="text" class="form-control" id="user-name" name="pin" placeholder="Pin Kodunuz" required>
														<div class="form-control-position">
															<i class="feather icon-user"></i>
														</div>
														<label for="user-name">Pin Kodunuz</label>
													</fieldset>
...
var sayi1 = Math.round(Math.random()*49);
var sayi2 = Math.round(Math.random()*49);
