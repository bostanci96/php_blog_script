...
$kquery = $db->query("SELECT * FROM duzsayfa INNER JOIN uyeler ON uye_id=sayfa_yazar ORDER BY sayfa_tarih DESC");
...
if ($verirow["uye_kadisecimi"]==1) {
    ...
    $data[]=array(
        ...
        $verirow['sayfa_tarih'],
        $verirow['sayfa_adi'],
        URL.DUZSAYFA.$verirow["sayfa_url"],
        $yazaradi,
...
exportExcel($ayar["site_title"]."-Duz_Sayfalar",$columns,$data,$replaceDotCol);
