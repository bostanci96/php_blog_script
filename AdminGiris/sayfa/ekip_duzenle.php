	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">Ekip Düzenle</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
							</li>

							<li class="breadcrumb-item active"><a href="javascript:void(0);">Ekip Düzenle </a>
							</li>
						</ol>
					</div>
				</div>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title">   <p><b><?php echo $slideRow["fotograf_shortDesc"];?></b>  düzenleniyor.. </p> </h4>
						</div>
						<div class="card-content">
							<div class="card-body">
								<form role="form" id="forms" method="POST" action="ajax.php?p=fotograf_edit"  enctype="multipart/form-data">
									<input type="hidden" name="fotograf_bolum" value="110699" />
												...
												<div class="tab-pane active" id="home-fill" role="tabpanel" aria-labelledby="home-tab-fill">
													...
													<div class="col-12">
														<div class="form-group row">
															...
															<div class="col-md-10">
																<fieldset class="position-relative has-icon-left">
																	<input type="text" id="first-name" class="form-control" name="fotograf_shortDesc2" value="<?php echo $slideRow["fotograf_shortDesc2"];?>" placeholder="Ahmet X">
																	<div class="form-control-position">
																		<i class="feather icon-type"></i>
																	</div>
																</fieldset>
...
-->
												...
												<div class="tab-pane" id="profile-fill" role="tabpanel" aria-labelledby="profile-tab-fill">
													...
													<div class="col-12">
														<div class="form-group row">
															<div class="col-md-2">
																<span>EN Müşteri Ünvan</span>
															</div>
															<div class="col-md-10">
																<fieldset class="position-relative has-icon-left">
																	<input type="text" id="first-name" class="form-control" name="en_fotograf_shortDesc2" value="<?php echo $slideRow["en_fotograf_shortDesc2"];?>" placeholder="Ahmet X">
																	<div class="form-control-position">
																		<i class="feather icon-type"></i>
																	</div>
																</fieldset>
												...
												<div class="tab-pane" id="messages-fill" role="tabpanel" aria-labelledby="messages-tab-fill">
													...
													<div class="col-12">
														<div class="form-group row">
															<div class="col-md-2">
																<span>AR Müşteri Ünvan</span>
															</div>
															<div class="col-md-10">
																<fieldset class="position-relative has-icon-left">
																	<input type="text" id="first-name" class="form-control" name="ar_fotograf_shortDesc2" value="<?php echo $slideRow["ar_fotograf_shortDesc2"];?>" placeholder="Ahmet X">
																	<div class="form-control-position">
																		<i class="feather icon-type"></i>
																	</div>
																</fieldset>
												...
												<div class="tab-pane" id="settings-fill" role="tabpanel" aria-labelledby="settings-tab-fill">
													...
													<div class="col-12">
														<div class="form-group row">
															<div class="col-md-2">
																<span>RU Müşteri Ünvan</span>
															</div>
															<div class="col-md-10">
																<fieldset class="position-relative has-icon-left">
																	<input type="text" id="first-name" class="form-control" name="fa_fotograf_shortDesc2" value="<?php echo $slideRow["fa_fotograf_shortDesc2"];?>" placeholder="Ahmet X">
																	<div class="form-control-position">
																		<i class="feather icon-type"></i>
																	</div>
																</fieldset>
