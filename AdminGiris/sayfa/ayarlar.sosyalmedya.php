											...
											<div class="row">
												...
												<div class="col-12">
													<div class="form-group row">
														...
														<div class="col-md-10">
															<fieldset class="position-relative has-icon-left">
																<input type="text" class="form-control" id="iconLeft1" placeholder="Pinterest" name="instagram_url" value="<?php echo $ayarRow["instagram_url"];?>">
																<div class="form-control-position">
												...
												<div class="col-12">
													<div class="form-group row">
														<div class="col-md-2">
															<span>Tumblr Url</span>
														</div>
														<div class="col-md-10">
															<fieldset class="position-relative has-icon-left">
																<input type="text" class="form-control" id="iconLeft1" placeholder="Tumblr Url " name="linkedin_url" value="<?php echo $ayarRow["linkedin_url"];?>">
																<div class="form-control-position">
