				...
				<div class="actions action-btns"><div class="dt-buttons btn-group">
					...
					<table class="table data-list-view">
						...
						<tbody>
							...
							<?php
							$kquery = $db->query("SELECT * FROM haberkategori WHERE kat_secenek=1 LIMIT ".$tablobaslangic.",".$tablobitis." ");
							if($kquery->rowCount()){
								...
								<tr>
									...
									<td><a target="_blank" href="<?php echo URL.HBURL."/".$kRow["kategori_id"]."_".$kRow["kategori_url"];?>/">Kategoriye Git </a></td>
									<td>    <?php
...
return false;
			...
			$.post('ajax.php?p=tek_habercat_sabit', {id: catId}, function (data) {
				if(data=="basarili"){
					sweetAlert({
						title	: "Başarılı",
