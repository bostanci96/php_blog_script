											...
											<div class="tab-content pt-1">
												<div class="tab-pane active" id="home-fill" role="tabpanel" aria-labelledby="home-tab-fill">
													...
													<div class="col-12">
														<div class="form-group row">
															<div class="col-md-2">
																<span>Astroloji Anasayfa Seo Açıklama</span>
															</div>
															<div class="col-md-10">
																<fieldset class="form-group">
																	<textarea class="form-control" id="basicTextarea" rows="3" placeholder="Astroloji Anasayfa Seo Açıklama" name="en_site_desc"><?php echo $ayarRow["en_site_desc"];?></textarea>
																</fieldset>
															</div>
														</div>
													</div>
													...
													<div class="col-12">
														<div class="form-group row">
															<div class="col-md-2">
																<span>Galeri Anasayfa Seo Açıklama</span>
															</div>
															<div class="col-md-10">
																<fieldset class="form-group">
																	<textarea class="form-control" id="basicTextarea" rows="3" placeholder="Galeri Anasayfa Seo Açıklama" name= "en_site_keyw"><?php echo $ayarRow["en_site_keyw"];?></textarea>
																</fieldset>
															</div>
														</div>
													</div>
