				...
				<div class="col-12">
					...
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="index.php?sayfa=kategoriler2">Kategoriler</a>
							</li>
							...
							<div class="card-body">
								<form role="form" id="forms" method="POST" action="ajax.php?p=kategori_edit"  enctype="multipart/form-data">
									<input type="hidden" name="kategori_id" value="<?php echo $catRow["kategori_id"];?>" />
										...
										<input type="hidden" name="ust_kategori" value="<?php echo $catRow["ust_kategori"];?>" />
											<input type="hidden" name="kategori_aciklama" value="<?php echo $catRow["kategori_aciklama"];?>" />
									<div class="form-body">
										<div class="row">
												...
												<div class="tab-pane" id="profile-fill" role="tabpanel" aria-labelledby="profile-tab-fill">
													...
													<div class="col-12">
														<div class="form-group row">
															...
															<div class="col-md-10">
																<fieldset class="position-relative has-icon-left">
																	<input type="desc" id="email-id" class="form-control" name="en_resim_baslik" value="<?php echo $catRow["en_resim_baslik"];?>" placeholder="Resim Başlık">
																	<div class="form-control-position">
																		<i class="feather icon-star"></i>
																	</div>
																</fieldset>
												...
												<div class="tab-pane" id="messages-fill" role="tabpanel" aria-labelledby="messages-tab-fill">
													...
													<div class="col-12">
														<div class="form-group row">
															...
															<div class="col-md-10">
																<fieldset class="position-relative has-icon-left">
																	<input type="desc" id="email-id" class="form-control" name="ar_resim_baslik" value="<?php echo $catRow["ar_resim_baslik"];?>" placeholder="Resim Başlık">
																	<div class="form-control-position">
																		<i class="feather icon-star"></i>
																	</div>
																</fieldset>
												...
												<div class="tab-pane" id="settings-fill" role="tabpanel" aria-labelledby="settings-tab-fill">
													...
													<div class="col-12">
														<div class="form-group row">
															...
															<div class="col-md-10">
																<fieldset class="position-relative has-icon-left">
																	<input type="desc" id="email-id" class="form-control" name="fa_resim_baslik" value="<?php echo $catRow["fa_resim_baslik"];?>" placeholder="Resim Başlık">
																	<div class="form-control-position">
																		<i class="feather icon-star"></i>
																	</div>
																</fieldset>
