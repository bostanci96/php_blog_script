							...
							<div class="row">
								<div class="col-12">
									<div class="form-group row">
										...
										<div class="col-md-10">
											<fieldset class="position-relative has-icon-left">
												<input type="text" class="form-control" id="iconLeft1" name="uye_kadi"  placeholder="">
									...
									<div class="form-group row">
										...
										<div class="col-md-10">
											<fieldset class="position-relative has-icon-left">
												<input type="text" class="form-control" id="iconLeft1" name="uye_url"  placeholder="">
												<div class="form-control-position">
													<i class="feather icon-phone"></i>
												</div>
											</fieldset>
								...
								<div class="col-12">
									<div class="form-group row">
										...
										<div class="col-md-10">
											<fieldset class="position-relative has-icon-left">
												<input type="password" class="form-control" id="iconLeft1" placeholder="Pin Girin" name="uye_pin">
												<div class="form-control-position">
													<i class="feather icon-star"></i>
												</div>
											</fieldset>
										...
										<div class="col-md-10">
											<fieldset class="form-group">
												<select class="form-control" name="uye_kadisecimi" >
													<option value="0">İsmimi Göster</option>
													<option value="1">Kullanıcı Adımı Göster</option>
												</select>
											</fieldset>
										</div>
									</div>
