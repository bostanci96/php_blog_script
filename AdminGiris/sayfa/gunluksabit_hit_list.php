	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">Günlük Düz Sayfa Hit İşlemleri</h2>
				...
				<div class="actions action-btns">
					...
					<table class="table  data-list">
						...
						<tbody>
							...
							<?php
							$uyeQuery = $db->query("SELECT * FROM duzsayfa INNER JOIN uyeler ON uye_id=sayfa_yazar ORDER BY yazi_gunluk_hit DESC LIMIT ".$tablobaslangic.",".$tablobitis." ");
  ...
  $yazaradi = $uyeRow["uye_kadi"];
      ...
      $yazaradi = $uyeRow["uye_ad"]." ".$uyeRow["uye_soyad"];
									...
									<tr>
										...
										<td><img src="<?PHP echo URL;?>images/duzsayfa/thumb/<?php echo $uyeRow["sayfa_resim"];?>" style="width:50px"></td>
...
return false;
		...
		$.post('ajax.php?p=duzsayfahit_bosalt', {id: log_id}, function (data) {
			if(data=="basarili"){
				sweetAlert({
						title	: "Başarılı",
