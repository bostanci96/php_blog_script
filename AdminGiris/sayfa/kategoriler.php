				...
				<div class="col-12">
					...
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a href="index.php?sayfa=kategoriler">Tüm Kategoriler </a>
							</li>
						</ol>
					</div>
				</div>
		...
		<section id="data-list-view" class="data-list-view-header">
			...
			<div class="table-responsive">
				<div class="actions action-btns"><div class="dt-buttons btn-group">
					<a href="index.php?sayfa=kategori_ekle" class="btn btn-outline-primary" tabindex="0" aria-controls="DataTables_Table_0"><span><i class="feather icon-plus"></i> Yeni Ekle</span></a> </div></div>
					<table class="table data-list-view">
						...
						<tbody>
							...
							<?php
							$kquery = $db->query("SELECT * FROM kategoriler WHERE kat_secenek=1");
							if($kquery->rowCount()){
								foreach($kquery as $kRow){           $ustId = $kRow["kategori_ust_id"];
								if($ustId==0){
									$ustKat = "Ana Kategori";
								}else{
									$ustCatQuery = $db->query("SELECT kategori_adi FROM kategoriler WHERE kategori_id='$ustId' AND kat_secenek=1");
								...
								<tr>
									...
									<td><a target="_blank" href="<?php echo URL."kategoriler/".$kRow["kategori_id"]."/".$kRow["kategori_url"];?>/">Kategoriye Git </a></td>
									<td>    <?php
									if($kRow["kategori_durum"]==1){ ?>
										...
										<td > <div class="dropdown dropright">
											...
											<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
												<a class="dropdown-item" href="index.php?sayfa=kategori_duzenle&id=<?php echo $kRow["kategori_id"];?>">Görüntüle / Düzenle</a>
