													...
													<div class="col-md-10">
														<fieldset class="form-group">
															<select class="form-control" id="basicSelect" name="menu_type">
																<option <?php echo $menuRow["menu_type"]==0 ? 'selected' : null; ?> value="0">Header Ana Menü</option>
																<option <?php echo $menuRow["menu_type"]==5 ? 'selected' : null; ?> value="5">Header Sub Menü</option>
																<option <?php echo $menuRow["menu_type"]==1 ? 'selected' : null; ?> value="1">Header Kayar Menü</option>
																<option <?php echo $menuRow["menu_type"]==6 ? 'selected' : null; ?> value="6">Mobil Kayar Menü</option>
																<option <?php echo $menuRow["menu_type"]==2 ? 'selected' : null; ?> value="2">Footer Üst Menü</option>
																<option <?php echo $menuRow["menu_type"]==3 ? 'selected' : null; ?> value="3">Footer Listeli Menü</option>
															<!--	<option <?php echo $menuRow["menu_type"]==4 ? 'selected' : null; ?> value="4">Taban Menü</option>      -->                                              
															</select>
														</fieldset>
													</div>
												</div>
