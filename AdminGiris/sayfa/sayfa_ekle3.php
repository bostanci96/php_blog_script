...
function Kategori_Select($tree,$level=0){
	...
	if($sorgula->rowCount()){
		...
		{
				if($item["def_kat_ayar"]==2){$sel="selected";}else{$sel="";}
	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-0">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">Makale Ekle</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
						</li>
						<li class="breadcrumb-item"><a href="index.php?sayfa=sayfalar2">Makaleler</a>
					</li>
					<li class="breadcrumb-item active"><a href="javascript:void(0);">Yeni Makale Ekle</a>
				</li>
			</ol>
		</div>
	</div>
	...
	<div class="col-12">
		<div class="card">
			...
			<div class="card-content">
				<div class="card-body">
					<form role="form" class="form-horizontal"  id="forms" method="POST" id="forms" method="POST" action="ajax.php?p=makale_ekle"  enctype="multipart/form-data">
									...
									<div class="row">
											...
											<div class="form-group row">
												...
												<div class="col-md-12">
													<fieldset class="position-relative has-icon-left">
														<input type="text" class="form-control"  placeholder="Makale Başlığı girin " name="sayfa_adi">
										...
										<div class="col-12">
											<div class="form-group row">
												...
												<div class="col-md-12">
													<fieldset class="position-relative has-icon-left">
														<textarea  type="text" class="form-control"  placeholder="Makale Kısa Açıklaması " name="sayfa_desc"></textarea>
														<div class="form-control-position">
...
<div class="col-12">
								...
								<div class="col-12">
										...
										<?php if ($_SESSION["uye_rutbe"] != 3) { ?>
											...
											<div class="form-group row">
												...
												<div class="col-md-12">
													...
													<div class="custom-control custom-checkbox">
														<input type="checkbox" name="makalekonum_astroloji" class="custom-control-input" id="customCheck9asdasdsa"/>
														<label class="custom-control-label ft1"  for="customCheck9asdasdsa">Astroloji Sağ Alan</label>
													</div>
												</div>
											</div>
										</div>
										...
										<?php if ($_SESSION["uye_rutbe"] == 0 OR $_SESSION["uye_rutbe"] == 1 ) { ?>
										<div class="col-12">
											<div class="form-group row">
												<div class="col-md-12">
	...
	$(document).ready(function(event) {
		$('#forms').ajaxForm({
			...
			uploadProgress: function(event, position, total, percentComplete) {
				swal({
					title: "Yükleniyor",
					text : "Makale Fotoğrafları Yükleniyor. Lütfen Bekleyiniz",
					type : "info",
			...
			success: function(data) {
				if(data=="bos-deger"){
					...
					sweetAlert({
										title	: "Başarılı",
										text 	: "Makale Başarılı Bir Şekilde Eklendi",
										type	: "success"
					},
					function(){
