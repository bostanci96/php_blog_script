...
$ayarControl = $db->query("SELECT * FROM dil2_bloklar");
	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">2. Dil Dosyası</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
							</li>

							<li class="breadcrumb-item active"><a href="javascript:void(0);">2. Dil Dosyası</a>
							</li>
						</ol>
					</div>
				</div>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title">   <p><b>2. Dil Dosyasını</b>  Düzenle </p> </h4>
						</div>
							...
							<ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
										...
										<div class="tab-content pt-1">
											<div class="tab-pane <?php if($_SESSION["uye_rutbe"]==0 OR $_SESSION["uye_rutbe"]==1){ echo "active";} ?> " id="home-fill" role="tabpanel" aria-labelledby="home-tab-fill">
												...
												<form role="form" class="form-horizontal"  id="forms2" method="POST" action="ajax.php?p=dil2_anasayfa_ayarlari"  enctype="multipart/form-data">
													<div class="col-12">
											...
											$ayarControl = $db->query("SELECT * FROM dil2_bloklar_en");
											if($ayarControl->rowCount()){
												$ayarRow = $ayarControl->fetch(PDO::FETCH_ASSOC);
											}else{
												die('error: 302 !');
											...
											<div class="tab-pane <?php if($_SESSION["uye_rutbe"]==2){ echo "active";} ?>" id="profile-fill" role="tabpanel" aria-labelledby="profile-tab-fill">
												...
												<!-- İngilizce başlangıç -->
												<form role="form" class="form-horizontal"  id="forms" method="POST" action="ajax.php?p=dil2_en_anasayfa_ayarlari"  enctype="multipart/form-data">
											...
											<?php
											echo !defined('ADMIN') ? die('error: 404 !') : null;
											$ayarControl = $db->query("SELECT * FROM dil2_bloklar_ar");
											if($ayarControl->rowCount()){
												$ayarRow = $ayarControl->fetch(PDO::FETCH_ASSOC);
											}else{
												die('error: 302 !');
											...
											<div class="tab-pane <?php if($_SESSION["uye_rutbe"]==3){ echo "active";} ?>" id="messages-fill" role="tabpanel" aria-labelledby="messages-tab-fill">
												<!-- Arapça başlangıç -->
												<form role="form" class="form-horizontal"  id="forms3" method="POST" action="ajax.php?p=dil2_ar_anasayfa_ayarlari"  enctype="multipart/form-data">
											...
											<?php
											echo !defined('ADMIN') ? die('error: 404 !') : null;
											$ayarControl = $db->query("SELECT * FROM dil2_bloklar_fa");
											if($ayarControl->rowCount()){
												$ayarRow = $ayarControl->fetch(PDO::FETCH_ASSOC);
											}else{
												die('error: 302 !');
											...
											<div class="tab-pane <?php if($_SESSION["uye_rutbe"]==4){ echo "active";} ?>" id="settings-fill" role="tabpanel" aria-labelledby="settings-tab-fill">
												...
												<form role="form" class="form-horizontal"  id="forms4" method="POST" action="ajax.php?p=dil2_fa_anasayfa_ayarlari"  enctype="multipart/form-data">
													<div class="col-12">
														<div class="form-group row">
															<div class="col-md-2">
