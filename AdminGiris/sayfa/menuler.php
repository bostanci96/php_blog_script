							...
							if($kquery->rowCount()){
								...
								<tr>
									...
									<td>
										...
										<div class="chip">
											<div class="chip-body">
												<div class="chip-text"> <?php if($kRow["menu_type"]==0){ ?> Header Ana Menü <?php }else if($kRow["menu_type"]==1){?> Header Kayar Menü <?php }else if($kRow["menu_type"]==2){ ?> Footer Üst Menü<?php }else if($kRow["menu_type"]==3){ ?>Footer Listeli Menü <?php }else if($kRow["menu_type"]==5){ ?>	Header Sub Menü<?php }else if($kRow["menu_type"]==6){ ?>	Mobil Kayar Menü<?php }?></div>
											</div>
											</div>
...
swal({
title: "Emin misin?",
text: "Bu Menüyü kurtaramayacaksınız!",
type: "warning",
...
swal("İptal edildi", "Menü güvende :)", "error");
return false;
}
});
