...
if(isset($_GET["id"])){
	$id = g("id");
	$pageControl = $db->prepare("SELECT * FROM burclar WHERE sayfa_id=:id");
	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-0">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">Burç Düzenle</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
						</li>
						<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>index.php?sayfa=burclar">Burçlar</a>
					</li>
					<li class="breadcrumb-item active"><a href="javascript:void(0);"><b><?php echo $pageRow["sayfa_adi"];?> </b> Adlı Burç Düzenleniyor</a>
				</li>
			</ol>
		</div>
	</div>
	...
	<div class="col-12">
		<div class="card">
			...
			<div class="card-content">
				<div class="card-body">
					<form role="form"id="forms" method="POST" action="ajax.php?p=burc_edit"  enctype="multipart/form-data">
						...
						<div class="form-body">
							<ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
								...
								<li class="nav-link">
									<a class="nav-link" id="img-tab-fill" data-toggle="tab" href="#img-fill" role="tab" aria-controls="img-fill" aria-selected="false"><i class="feather icon-image"></i> Burç İçerik Alanları</a>
								</li>
									...
									<div class="col-12">
										<div class="form-group row">
											...
											<div class="col-12">
												<div class="form-group row">
													<div class="col-md-12">
														<span>"<?php echo $pageRow["sayfa_adi"];?>" Genel Durum</span>
													</div>
													<div class="col-md-12">
														<fieldset class="position-relative has-icon-left">
															<textarea type="text" class="form-control"  placeholder="Genel Durum" value="" name="en_sayfa_adi"><?php echo $pageRow["en_sayfa_adi"];?></textarea>
											...
											<div class="col-12">
												<div class="form-group row">
													<div class="col-md-12">
														<span>"<?php echo $pageRow["sayfa_adi"];?>" Aşk Falı</span>
													</div>
													<div class="col-md-12">
														<fieldset class="position-relative has-icon-left">
															<textarea type="text" class="form-control"  placeholder="Aşk Falı" value="" name="en_sayfa_desc"><?php echo $pageRow["en_sayfa_desc"];?></textarea>
															<div class="form-control-position">
																<i class="feather icon-file-text"></i>
															</div>
														</fieldset>
											...
											<div class="col-12">
												<div class="form-group row">
													<div class="col-md-12">
														<span>"<?php echo $pageRow["sayfa_adi"];?>" İş & Kariyer Falı</span>
													</div>
													<div class="col-md-12">
														<fieldset class="position-relative has-icon-left">
															<textarea type="text" class="form-control"  placeholder="İş & Kariyer Falı" value="" name="en_sayfa_icerik"><?php echo $pageRow["en_sayfa_icerik"];?></textarea>
															<div class="form-control-position">
																<i class="feather icon-file-text"></i>
															</div>
														</fieldset>
											...
											<div class="col-12">
												<div class="form-group row">
													<div class="col-md-12">
														<span>"<?php echo $pageRow["sayfa_adi"];?>" Maddi Durum & Para Falı</span>
													</div>
													<div class="col-md-12">
														<fieldset class="position-relative has-icon-left">
															<textarea type="text" class="form-control"  placeholder="Maddi Durum & Para Falı" value="" name="ar_sayfa_adi"><?php echo $pageRow["ar_sayfa_adi"];?></textarea>
															<div class="form-control-position">
																<i class="feather icon-file-text"></i>
															</div>
														</fieldset>
											...
											<div class="col-12">
												<div class="form-group row">
													<div class="col-md-12">
														<span>"<?php echo $pageRow["sayfa_adi"];?>" Mynet Sitesi</span>
													</div>
													<div class="col-md-12">
														<fieldset class="position-relative has-icon-left">
															<textarea type="text" class="form-control"  placeholder="Mynet Sitesi" value="" name="ar_sayfa_desc"><?php echo $pageRow["ar_sayfa_desc"];?></textarea>
															<div class="form-control-position">
																<i class="feather icon-file-text"></i>
															</div>
														</fieldset>
											...
											<div class="col-12">
												<div class="form-group row">
													<div class="col-md-12">
														<span>"<?php echo $pageRow["sayfa_adi"];?>" Sabah Gazetesi</span>
													</div>
													<div class="col-md-12">
														<fieldset class="position-relative has-icon-left">
															<textarea type="text" class="form-control"  placeholder="Sabah Gazetesi" value="" name="ar_sayfa_icerik"><?php echo $pageRow["ar_sayfa_icerik"];?></textarea>
															<div class="form-control-position">
																<i class="feather icon-file-text"></i>
															</div>
														</fieldset>
											...
											<div class="col-12">
												<div class="form-group row">
													<div class="col-md-12">
														<span>"<?php echo $pageRow["sayfa_adi"];?>" Hürriyet Gazetesi</span>
													</div>
													<div class="col-md-12">
														<fieldset class="position-relative has-icon-left">
															<textarea type="text" class="form-control"  placeholder="Hürriyet Gazetesi" value="" name="fa_sayfa_adi"><?php echo $pageRow["fa_sayfa_adi"];?></textarea>
															<div class="form-control-position">
																<i class="feather icon-file-text"></i>
															</div>
														</fieldset>
											...
											<div class="col-12">
												<div class="form-group row">
													<div class="col-md-12">
														<span>"<?php echo $pageRow["sayfa_adi"];?>" Milliyet Gazetesi</span>
													</div>
													<div class="col-md-12">
														<fieldset class="position-relative has-icon-left">
															<textarea type="text" class="form-control"  placeholder="Milliyet Gazetesi" value="" name="fa_sayfa_desc"><?php echo $pageRow["fa_sayfa_desc"];?></textarea>
															<div class="form-control-position">
																<i class="feather icon-file-text"></i>
															</div>
														</fieldset>
											...
											<div class="col-12">
												<div class="form-group row">
													<div class="col-md-12">
														<span>"<?php echo $pageRow["sayfa_adi"];?>" Takvim Gazetesi</span>
													</div>
													<div class="col-md-12">
														<fieldset class="position-relative has-icon-left">
															<textarea type="text" class="form-control"  placeholder="Takvim Gazetesi" value="" name="fa_sayfa_icerik"><?php echo $pageRow["fa_sayfa_icerik"];?></textarea>
															<div class="form-control-position">
																<i class="feather icon-file-text"></i>
															</div>
														</fieldset>
											...
											<div class="col-12">
												<div class="form-group row">
													<div class="col-md-12">
														<span>"<?php echo $pageRow["sayfa_adi"];?>" Sözcü Gazetesi</span>
													</div>
													<div class="col-md-12">
														<fieldset class="position-relative has-icon-left">
															<textarea type="text" class="form-control"  placeholder="Sözcü Gazetesi" value="" name="en_sayfa_keyw"><?php echo $pageRow["en_sayfa_keyw"];?></textarea>
															<div class="form-control-position">
																<i class="feather icon-file-text"></i>
															</div>
														</fieldset>
											...
											<div class="col-12">
												<div class="form-group row">
													<div class="col-md-12">
														<span>"<?php echo $pageRow["sayfa_adi"];?>" HaberTürk Gazetesi</span>
													</div>
													<div class="col-md-12">
														<fieldset class="position-relative has-icon-left">
															<textarea type="text" class="form-control"  placeholder="HaberTürk Gazetesi" value="" name="ar_sayfa_keyw"><?php echo $pageRow["ar_sayfa_keyw"];?></textarea>
															<div class="form-control-position">
																<i class="feather icon-file-text"></i>
															</div>
														</fieldset>
											...
											<div class="col-12">
												<div class="form-group row">
													<div class="col-md-12">
														<span>"<?php echo $pageRow["sayfa_adi"];?>" Rezzan Kiraz</span>
													</div>
													<div class="col-md-12">
														<fieldset class="position-relative has-icon-left">
															<textarea type="text" class="form-control"  placeholder="Rezzan Kiraz" value="" name="fa_sayfa_keyw"><?php echo $pageRow["fa_sayfa_keyw"];?></textarea>
															<div class="form-control-position">
																<i class="feather icon-file-text"></i>
															</div>
														</fieldset>
											...
											<div class="col-12">
												<div class="form-group row">
													<div class="col-md-12">
														<span>"<?php echo $pageRow["sayfa_adi"];?>" Nuray Sayarı</span>
													</div>
													<div class="col-md-12">
														<fieldset class="position-relative has-icon-left">
															<textarea type="text" class="form-control"  placeholder="Nuray Sayarı" value="" name="en_resim_baslik"><?php echo $pageRow["en_resim_baslik"];?></textarea>
															<div class="form-control-position">
																<i class="feather icon-file-text"></i>
															</div>
														</fieldset>
											...
											<div class="col-12">
												<div class="form-group row">
													<div class="col-md-12">
														<span>"<?php echo $pageRow["sayfa_adi"];?>" Hande Kazanova</span>
													</div>
													<div class="col-md-12">
														<fieldset class="position-relative has-icon-left">
															<textarea type="text" class="form-control"  placeholder="Hande Kazanova" value="" name="ar_resim_baslik"><?php echo $pageRow["ar_resim_baslik"];?></textarea>
															<div class="form-control-position">
																<i class="feather icon-file-text"></i>
															</div>
														</fieldset>
									...
									<div class="row">
										<div class="col-md-10">
											<div class="row">
												<div class="col-12">
													<div class="form-group row">
														<div class="col-md-12">
															<span>Burç Başlık</span>
														</div>
														<div class="col-md-12">
															<fieldset class="position-relative has-icon-left">
																<input type="text" class="form-control"  placeholder="Burç Başlığı girin " value="<?php echo $pageRow["sayfa_adi"];?>" name="sayfa_adi">
																<div class="form-control-position">
												...
												<div class="col-12">
													<div class="form-group row">
														<div class="col-md-12">
															<span>Burç Acıklama</span>
														</div>
														<div class="col-md-12">
															<fieldset class="position-relative has-icon-left">
																<textarea type="text" class="form-control"  placeholder="Burç Kısa Açıklaması " value="" name="sayfa_desc"><?php echo $pageRow["sayfa_desc"];?></textarea>
																<div class="form-control-position">
																	<i class="feather icon-file-text"></i>
																</div>
															</fieldset>
												...
												<div class="col-12">
													<div class="form-group row">
														<div class="col-md-12">
															<span>Burç İçerik</span>
														</div>
														<div class="col-md-12">
															<textarea class="ckeditor" id="bootstrapck" name="sayfa_icerik">d<?php echo $pageRow["sayfa_icerik"];?></textarea>
												...
												<!--<div class="col-12">
														<div class="form-group row">
																<div class="col-md-12">
																		<span>Burç Etiketleri <small>(Virgül ile ayırarak yazınız.)</small></span>
																</div>
																<div class="col-md-12">
										...
										<div class="col-md-2">
											...
											<div class="form-group row">
												...
												<div class="col-md-5"><img src="<?php echo URL;?>images/burclar/thumb/<?php echo $pageRow["sayfa_resim"];?>" style="width: 150px;"></div>
												<div class="col-12">
													<div class="form-group row">
														<div class="col-md-12">
												...
												<div class="col-md-5"><img src="<?php echo URL;?>images/burclaricon/thumb/<?php echo $pageRow["sayfa_resim2"];?>" style="width: 150px;"></div>
												<div class="col-12">
													<div class="form-group row">
														<div class="col-md-12">
															<span>Resim Başlık</span>
														...
														<div class="col-md-12">
															<input type="text" class="form-control"   placeholder="Örn Kalem, Silgi, Defter Gibi .." value="<?php echo $pageRow["makalekonum_footeryazi"];?>" name="makalekonum_footeryazi">
														</div>
													</div>
												</div>
												<!--	<div class="col-12">
													...
													<div class="form-group row">
														...
														<div class="col-md-12">
															<select name="sayfa_yazar" class="form-control" required=""  >
																...
																<?php
																		$sayfaQxx = $db->query("SELECT * FROM uyeler WHERE uye_onay=1 AND  uye_rutbe=1 OR uye_rutbe=0");
												...
												<!--<div class="col-12">
																...
																<label class="custom-control-label ft1" for="customCheck99">Popüler Burç</label>
															</div>
														</div>
													</div>
												</div>-->
												<div class="col-12">
													<div class="form-group row">
														<div class="col-md-12">
															<span>Burç İnceleme Sayısı</span>
														</div>
														<div class="col-md-12">
											...
											<!--	<div class="col-12">
													<div class="form-group row">
														<div class="col-md-12">
															<span>Burç Tarih Aralığı</span>
														</div>
														<div class="col-md-12">
															<input type="text" class="form-control" value="<?php echo $pageRow["tariharalik"];?>"  placeholder="" name="tariharalik">
														</div>
													</div>
												</div>-->
											</div>
...
sweetAlert({
title	: "Başarılı",
text 	: "Burç Başarılı Bir Şekilde Güncellendi",
type	: "success"
});
return false;
}else{
