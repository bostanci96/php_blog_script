	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">Düz Sayfa İşlemleri</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
						</li>
						<li class="breadcrumb-item active"><a href="<?php echo ADMIN_URL ;?>index.php?sayfa=duzsayfalar">Tüm Düz Sayfalar </a>
					</li>
				</ol>
			</div>
		</div>
...
<section id="data-list-view" class="data-list-view-header">
	...
	<div class="table-responsive">
		<div class="actions action-btns"><div class="dt-buttons btn-group">
			<a href="index.php?sayfa=duzsayfa_ekle" class="btn btn-outline-primary" tabindex="0" aria-controls="DataTables_Table_0"><span><i class="feather icon-plus"></i> Yeni Ekle</span></a> </div></div>
			...
			<tbody>
				<?php
				$uyeQuery = $db->query("SELECT * FROM duzsayfa INNER JOIN uyeler ON uye_id=sayfa_yazar ORDER BY sayfa_tarih DESC LIMIT ".$tablobaslangic.",".$tablobitis." ");
				...
				<tr>
					...
					<td><a target="_blank" href="<?php echo URL.DUZSAYFA.$uyeRow["sayfa_url"];?>"><?php echo $uyeRow["sayfa_adi"];?></a></td>
					...
					<td>[{=d:<?php echo $uyeRow["sayfa_id"];?>=}]</td>
					<td > <div class="dropdown dropright">
						<button class="btn btn-danger dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						İşlemler
						</button>
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
							<a class="dropdown-item" href="index.php?sayfa=duzsayfa_edit&id=<?php echo $uyeRow["sayfa_id"];?>">Görüntüle / Düzenle</a>
							...
							<?php if($uyeRow["sayfa_durum"]!=2){ ?>	<a class="dropdown-item"  onclick="durumDegis2(<?php echo $uyeRow["sayfa_id"];?>);" >Sayfayı Taslağa Çek</a> <?php } ?>
...
function(isConfirm){
if (isConfirm){
$.post('ajax.php?p=duzsayfa_sil', {id: sayfaId}, function (data) {
			if(data=="basarili"){
				sweetAlert({
							title	: "Başarılı",
...
return false;
	...
	function durumDegis(sayfaid){
		$.post('ajax.php?p=duzsayfaonay', {id: sayfaid}, function (data) {
		...
		$.post('ajax.php?p=duzsayfaonay2', {id: sayfaid}, function (data) {
			if(data=="yasaklama-basarili"){
				sweetAlert({
							title	: "Başarılı",
							text 	: "Sayfa başarılı bir şekilde taslağa alındı.",
							type	: "success"
				},
				function(){
					window.location.reload(true);
