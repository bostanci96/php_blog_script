...
if(isset($_GET["id"])){
	$id = g("id");
	$catControl = $db->prepare("SELECT * FROM haberkategori WHERE kategori_id=:id");
	...
	<div class="col-12">
		<div class="card">
			...
			<div class="card-content">
				<div class="card-body">
					<form role="form" id="forms" method="POST" action="ajax.php?p=haberkategori_edit"  enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-md-2">
									...
									<div class="col-12">
										...
										<div class="col-md-5"><img src="<?php echo URL;?>images/makaleler/big/<?php echo $catRow["kategori_sabitresim"];?>" class="img-fluid" style="max-width: 85px;"></div>


											<div class="col-12">
											<div class="form-group row">
												<div class="col-md-12">
													<span>Kategori Seçeneği </span>
												</div>
												<div class="col-md-12">
													<div class="custom-control custom-checkbox">
														<input type="checkbox" <?php echo $catRow["katkonum_yeni"] == "on" ? 'checked' : null; ?> name="katkonum_yeni" class="custom-control-input" id="customCheck8"/>
														<label class="custom-control-label ft1"  for="customCheck8">Astroloji Kategorisi Yap</label>
													</div>
